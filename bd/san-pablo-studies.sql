...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-10-2023 a las 03:25:21
...
--
-- Estructura de tabla para la tabla `resumenes-hojas`
--

CREATE TABLE `resumenes-hojas` (
  `id_resumen_hoja` int(11) NOT NULL,
  `id_resumen` int(11) NOT NULL,
  `ruta_resumen_hoja` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `resumenes-hojas`
--
ALTER TABLE `resumenes-hojas`
...
--
-- AUTO_INCREMENT de la tabla `resumenes-hojas`
--
ALTER TABLE `resumenes-hojas`
  MODIFY `id_resumen_hoja` int(11) NOT NULL AUTO_INCREMENT;
